...
class OpenApiIntegrationTest {
    ...
    @Test
    void 인증_없이_OpenAPI_문서에_접근할_수_있고_관리자_경로가_노출된다() throws Exception {
