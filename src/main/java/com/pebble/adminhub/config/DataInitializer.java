package com.pebble.adminhub.config;
...
import com.pebble.adminhub.user.domain.Gender;
 ...
 * 매칭 기록은 관리자 통계의 입력 데이터로만 쓰인다(AdminHub는 매칭 write 경로를 갖지 않는다).
 */
@Slf4j
@Component
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        notificationRepository.save(Notification.builder()
                .title("서비스 오픈 안내").message("AdminHub 관리자 콘솔이 오픈되었습니다.")
